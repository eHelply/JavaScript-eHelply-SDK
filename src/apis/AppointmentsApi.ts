...
export interface AppointmentsApiInterface {
     ...
     */
    addEntityToAppointmentRaw(requestParameters: AddEntityToAppointmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<boolean>>;

    /**
     * Addentitytoappointment
     */
    addEntityToAppointment(requestParameters: AddEntityToAppointmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<boolean>;
...
export class AppointmentsApi extends runtime.BaseAPI implements AppointmentsApiInterface {
     ...
     * Addentitytoappointment
     */
    async addEntityToAppointmentRaw(requestParameters: AddEntityToAppointmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<boolean>> {
     ...
     * Addentitytoappointment
     */
    async addEntityToAppointment(requestParameters: AddEntityToAppointmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<boolean> {
