...
export interface NotesApiInterface {
     ...
     */
    createNoteRaw(requestParameters: CreateNoteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<NoteDynamo>>;

    /**
     * Create Note
     */
    createNote(requestParameters: CreateNoteRequest, initOverrides?: RequestInit): Promise<NoteDynamo>;
     ...
     * @memberof NotesApiInterface
     */
    deleteNoteRaw(requestParameters: DeleteNoteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>>;

    /**
     * Delete Note
     */
    deleteNote(requestParameters: DeleteNoteRequest, initOverrides?: RequestInit): Promise<any>;
     ...
     * @memberof NotesApiInterface
     */
    getNoteRaw(requestParameters: GetNoteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<NoteDynamoHistory>>;

    /**
     * Get Note
     */
    getNote(requestParameters: GetNoteRequest, initOverrides?: RequestInit): Promise<NoteDynamoHistory>;
     ...
     * @memberof NotesApiInterface
     */
    updateNoteRaw(requestParameters: UpdateNoteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<NoteDynamo>>;

    /**
     * Update Note
     */
    updateNote(requestParameters: UpdateNoteRequest, initOverrides?: RequestInit): Promise<NoteDynamo>;
...
export class NotesApi extends runtime.BaseAPI implements NotesApiInterface {
     ...
     * Create Note
     */
    async createNoteRaw(requestParameters: CreateNoteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<NoteDynamo>> {
     ...
     * Create Note
     */
    async createNote(requestParameters: CreateNoteRequest, initOverrides?: RequestInit): Promise<NoteDynamo> {
     ...
     * Delete Note
     */
    async deleteNoteRaw(requestParameters: DeleteNoteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>> {
     ...
     * Delete Note
     */
    async deleteNote(requestParameters: DeleteNoteRequest, initOverrides?: RequestInit): Promise<any> {
     ...
     * Get Note
     */
    async getNoteRaw(requestParameters: GetNoteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<NoteDynamoHistory>> {
        if (requestParameters.noteId === null || requestParameters.noteId === undefined) {
     ...
     * Get Note
     */
    async getNote(requestParameters: GetNoteRequest, initOverrides?: RequestInit): Promise<NoteDynamoHistory> {
     ...
     * Update Note
     */
    async updateNoteRaw(requestParameters: UpdateNoteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<NoteDynamo>> {
        if (requestParameters.noteId === null || requestParameters.noteId === undefined) {
     ...
     * Update Note
     */
    async updateNote(requestParameters: UpdateNoteRequest, initOverrides?: RequestInit): Promise<NoteDynamo> {
