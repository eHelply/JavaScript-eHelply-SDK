...
export interface NotesApiInterface {
     ...
     * @memberof NotesApiInterface
     */
    getNoteRaw(requestParameters: GetNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NoteDynamoHistory>>;

    /**
     * Get Note
     */
    getNote(requestParameters: GetNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NoteDynamoHistory>;
...
export class NotesApi extends runtime.BaseAPI implements NotesApiInterface {
     ...
     * Get Note
     */
    async getNoteRaw(requestParameters: GetNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NoteDynamoHistory>> {
        if (requestParameters.noteId === null || requestParameters.noteId === undefined) {
     ...
     * Get Note
     */
    async getNote(requestParameters: GetNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NoteDynamoHistory> {
