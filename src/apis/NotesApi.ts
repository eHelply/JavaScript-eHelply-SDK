...
export interface NotesApiInterface {
     ...
     */
    createNoteRaw(requestParameters: CreateNoteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<CreateNoteResponse>>;

    /**
     * Createnote
     */
    createNote(requestParameters: CreateNoteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<CreateNoteResponse>;
...
export class NotesApi extends runtime.BaseAPI implements NotesApiInterface {
     ...
     * Createnote
     */
    async createNoteRaw(requestParameters: CreateNoteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<CreateNoteResponse>> {
     ...
     * Createnote
     */
    async createNote(requestParameters: CreateNoteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<CreateNoteResponse> {
