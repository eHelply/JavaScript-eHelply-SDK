...
export interface StaffApiInterface {
     ...
     */
    createStaffPlacesStaffPostRaw(requestParameters: CreateStaffPlacesStaffPostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<StaffDb>>;

    /**
     * Creates a staff member
     * Create Staff
     */
    createStaffPlacesStaffPost(requestParameters: CreateStaffPlacesStaffPostRequest, initOverrides?: RequestInit): Promise<StaffDb>;
     ...
     * @memberof StaffApiInterface
     */
    deleteStaffPlacesStaffStaffUuidDeleteRaw(requestParameters: DeleteStaffPlacesStaffStaffUuidDeleteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>>;

    /**
     * Deletes the staff member with the given ID and returns True if successful
     * Delete Staff
     */
    deleteStaffPlacesStaffStaffUuidDelete(requestParameters: DeleteStaffPlacesStaffStaffUuidDeleteRequest, initOverrides?: RequestInit): Promise<any>;
     ...
     * @memberof StaffApiInterface
     */
    getStaffPlacesStaffStaffUuidGetRaw(requestParameters: GetStaffPlacesStaffStaffUuidGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<StaffResponse>>;

    /**
     * Gets the staff member information given the staff ID
     * Get Staff
     */
    getStaffPlacesStaffStaffUuidGet(requestParameters: GetStaffPlacesStaffStaffUuidGetRequest, initOverrides?: RequestInit): Promise<StaffResponse>;
     ...
     * @memberof StaffApiInterface
     */
    searchStaffPlacesStaffGetRaw(requestParameters: SearchStaffPlacesStaffGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Page>>;

    /**
     * TODO Item return format: ``` {     uuid                                **type:** string     project_uuid                        **type:** string or None      entity                              **type:** string or None      place                               **type:** dict or None      company                             **type:** dict or None      schedule                            **type:** dict or None      catalog                             **type:** dict or None      reviews                             **type:** dict or None      created_at                          **type:** string or None      updated_at                          **type:** string or None      deleted_at                          **type:** string or None  } ```
     * Search Staff
     */
    searchStaffPlacesStaffGet(requestParameters: SearchStaffPlacesStaffGetRequest, initOverrides?: RequestInit): Promise<Page>;
     ...
     * @memberof StaffApiInterface
     */
    updateStaffPlacesStaffStaffUuidPutRaw(requestParameters: UpdateStaffPlacesStaffStaffUuidPutRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<StaffResponse>>;

    /**
     * Update staff with given info, only updating the fields supplied. Staff Uuid must be sent however.
     * Update Staff
     */
    updateStaffPlacesStaffStaffUuidPut(requestParameters: UpdateStaffPlacesStaffStaffUuidPutRequest, initOverrides?: RequestInit): Promise<StaffResponse>;
...
export class StaffApi extends runtime.BaseAPI implements StaffApiInterface {
     ...
     * Create Staff
     */
    async createStaffPlacesStaffPostRaw(requestParameters: CreateStaffPlacesStaffPostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<StaffDb>> {
     ...
     * Create Staff
     */
    async createStaffPlacesStaffPost(requestParameters: CreateStaffPlacesStaffPostRequest, initOverrides?: RequestInit): Promise<StaffDb> {
     ...
     * Delete Staff
     */
    async deleteStaffPlacesStaffStaffUuidDeleteRaw(requestParameters: DeleteStaffPlacesStaffStaffUuidDeleteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>> {
     ...
     * Delete Staff
     */
    async deleteStaffPlacesStaffStaffUuidDelete(requestParameters: DeleteStaffPlacesStaffStaffUuidDeleteRequest, initOverrides?: RequestInit): Promise<any> {
     ...
     * Get Staff
     */
    async getStaffPlacesStaffStaffUuidGetRaw(requestParameters: GetStaffPlacesStaffStaffUuidGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<StaffResponse>> {
        if (requestParameters.staffUuid === null || requestParameters.staffUuid === undefined) {
     ...
     * Get Staff
     */
    async getStaffPlacesStaffStaffUuidGet(requestParameters: GetStaffPlacesStaffStaffUuidGetRequest, initOverrides?: RequestInit): Promise<StaffResponse> {
     ...
     * Search Staff
     */
    async searchStaffPlacesStaffGetRaw(requestParameters: SearchStaffPlacesStaffGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Page>> {
        const queryParameters: any = {};
     ...
     * Search Staff
     */
    async searchStaffPlacesStaffGet(requestParameters: SearchStaffPlacesStaffGetRequest = {}, initOverrides?: RequestInit): Promise<Page> {
     ...
     * Update Staff
     */
    async updateStaffPlacesStaffStaffUuidPutRaw(requestParameters: UpdateStaffPlacesStaffStaffUuidPutRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<StaffResponse>> {
        if (requestParameters.staffUuid === null || requestParameters.staffUuid === undefined) {
     ...
     * Update Staff
     */
    async updateStaffPlacesStaffStaffUuidPut(requestParameters: UpdateStaffPlacesStaffStaffUuidPutRequest, initOverrides?: RequestInit): Promise<StaffResponse> {
