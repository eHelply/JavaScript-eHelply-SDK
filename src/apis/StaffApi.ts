...
export interface StaffApiInterface {
     ...
     */
    createStaffRaw(requestParameters: CreateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<StaffResponse>>;

    /**
     * Creates a staff member
     * Createstaff
     */
    createStaff(requestParameters: CreateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<StaffResponse>;
     ...
     * @memberof StaffApiInterface
     */
    deleteStaffRaw(requestParameters: DeleteStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>>;

    /**
     * Deletes the staff member with the given ID and returns True if successful
     * Deletestaff
     */
    deleteStaff(requestParameters: DeleteStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any>;
     ...
     * @memberof StaffApiInterface
     */
    getStaffRaw(requestParameters: GetStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<StaffResponse>>;

    /**
     * Gets the staff member information given the staff ID
     * Getstaff
     */
    getStaff(requestParameters: GetStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<StaffResponse>;
     ...
     * @memberof StaffApiInterface
     */
    searchStaffRaw(requestParameters: SearchStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>>;

    /**
     * TODO Item return format: ``` {     uuid                                **type:** string     project_uuid                        **type:** string or None      entity                              **type:** string or None      place                               **type:** dict or None      company                             **type:** dict or None      schedule                            **type:** dict or None      catalog                             **type:** dict or None      reviews                             **type:** dict or None      created_at                          **type:** string or None      updated_at                          **type:** string or None      deleted_at                          **type:** string or None  } ```
     * Searchstaff
     */
    searchStaff(requestParameters: SearchStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page>;
     ...
     * @memberof StaffApiInterface
     */
    updateStaffRaw(requestParameters: UpdateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<StaffResponse>>;

    /**
     * Update staff with given info, only updating the fields supplied. Staff Uuid must be sent however.
     * Updatestaff
     */
    updateStaff(requestParameters: UpdateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<StaffResponse>;
...
export class StaffApi extends runtime.BaseAPI implements StaffApiInterface {
     ...
     * Createstaff
     */
    async createStaffRaw(requestParameters: CreateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<StaffResponse>> {
        if (requestParameters.staffBase === null || requestParameters.staffBase === undefined) {
            throw new runtime.RequiredError('staffBase','Required parameter requestParameters.staffBase was null or undefined when calling createStaff.');
        }
        ...
        const response = await this.request({
            ...
            body: StaffBaseToJSON(requestParameters.staffBase),
        }, initOverrides);
     ...
     * Createstaff
     */
    async createStaff(requestParameters: CreateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<StaffResponse> {
     ...
     * Deletestaff
     */
    async deleteStaffRaw(requestParameters: DeleteStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Deletestaff
     */
    async deleteStaff(requestParameters: DeleteStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any> {
     ...
     * Getstaff
     */
    async getStaffRaw(requestParameters: GetStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<StaffResponse>> {
        if (requestParameters.staffUuid === null || requestParameters.staffUuid === undefined) {
     ...
     * Getstaff
     */
    async getStaff(requestParameters: GetStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<StaffResponse> {
     ...
     * Searchstaff
     */
    async searchStaffRaw(requestParameters: SearchStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>> {
        const queryParameters: any = {};
     ...
     * Searchstaff
     */
    async searchStaff(requestParameters: SearchStaffRequest = {}, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page> {
     ...
     * Updatestaff
     */
    async updateStaffRaw(requestParameters: UpdateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<StaffResponse>> {
        if (requestParameters.staffUuid === null || requestParameters.staffUuid === undefined) {
        ...
        if (requestParameters.staffBase === null || requestParameters.staffBase === undefined) {
            throw new runtime.RequiredError('staffBase','Required parameter requestParameters.staffBase was null or undefined when calling updateStaff.');
        }
     ...
     * Updatestaff
     */
    async updateStaff(requestParameters: UpdateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<StaffResponse> {
