...
export interface StaffApiInterface {
     ...
     */
    createStaffRaw(requestParameters: CreateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<StaffDb>>;

    /**
     * Creates a staff member
     * Createstaff
     */
    createStaff(requestParameters: CreateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<StaffDb>;
...
export class StaffApi extends runtime.BaseAPI implements StaffApiInterface {
     ...
     * Createstaff
     */
    async createStaffRaw(requestParameters: CreateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<StaffDb>> {
     ...
     * Createstaff
     */
    async createStaff(requestParameters: CreateStaffRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<StaffDb> {
