...
export interface MetaApiInterface {
     ...
     * @memberof MetaApiInterface
     */
    getMetaRaw(requestParameters: GetMetaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MetaDynamo>>;

    /**
     * Get Meta
     */
    getMeta(requestParameters: GetMetaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MetaDynamo>;
     ...
     * @memberof MetaApiInterface
     */
    getMetaFromUuidRaw(requestParameters: GetMetaFromUuidRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MetaDynamo>>;

    /**
     * Get Meta From Uuid
     */
    getMetaFromUuid(requestParameters: GetMetaFromUuidRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MetaDynamo>;
...
export class MetaApi extends runtime.BaseAPI implements MetaApiInterface {
     ...
     * Get Meta
     */
    async getMetaRaw(requestParameters: GetMetaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MetaDynamo>> {
        if (requestParameters.service === null || requestParameters.service === undefined) {
     ...
     * Get Meta
     */
    async getMeta(requestParameters: GetMetaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MetaDynamo> {
     ...
     * Get Meta From Uuid
     */
    async getMetaFromUuidRaw(requestParameters: GetMetaFromUuidRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MetaDynamo>> {
        if (requestParameters.metaUuid === null || requestParameters.metaUuid === undefined) {
     ...
     * Get Meta From Uuid
     */
    async getMetaFromUuid(requestParameters: GetMetaFromUuidRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MetaDynamo> {
