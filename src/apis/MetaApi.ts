...
export interface MetaApiInterface {
     ...
     * @memberof MetaApiInterface
     */
    getMetaFromUuidRaw(requestParameters: GetMetaFromUuidRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<MetaDynamo>>;

    /**
     * Get Meta From Uuid
     */
    getMetaFromUuid(requestParameters: GetMetaFromUuidRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<MetaDynamo>;
...
export class MetaApi extends runtime.BaseAPI implements MetaApiInterface {
     ...
     * Get Meta From Uuid
     */
    async getMetaFromUuidRaw(requestParameters: GetMetaFromUuidRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<MetaDynamo>> {
        if (requestParameters.metaUuid === null || requestParameters.metaUuid === undefined) {
     ...
     * Get Meta From Uuid
     */
    async getMetaFromUuid(requestParameters: GetMetaFromUuidRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<MetaDynamo> {
