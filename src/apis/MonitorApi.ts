...
import {
    ...
    ResponseGetservicespecFromJSON,
    ResponseGetservicespecToJSON,
    ResponseGetservicespecs,
    ResponseGetservicespecsFromJSON,
    ResponseGetservicespecsToJSON,
    ResponseGetserviceswithspecs,
    ResponseGetserviceswithspecsFromJSON,
    ResponseGetserviceswithspecsToJSON,
    ServiceCreate,
...
export interface MonitorApiInterface {
     ...
     * @memberof MonitorApiInterface
     */
    getServiceSpecRaw(requestParameters: GetServiceSpecRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ResponseGetservicespec>>;

    /**
     * Getservicespec
     */
    getServiceSpec(requestParameters: GetServiceSpecRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<ResponseGetservicespec>;
     ...
     * @memberof MonitorApiInterface
     */
    getServiceSpecsRaw(requestParameters: GetServiceSpecsRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ResponseGetservicespecs>>;

    /**
     * Getservicespecs
     */
    getServiceSpecs(requestParameters: GetServiceSpecsRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<ResponseGetservicespecs>;
     ...
     * @memberof MonitorApiInterface
     */
    getServicesWithSpecsRaw(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ResponseGetserviceswithspecs>>;

    /**
     * Getserviceswithspecs
     */
    getServicesWithSpecs(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<ResponseGetserviceswithspecs>;
...
export class MonitorApi extends runtime.BaseAPI implements MonitorApiInterface {
     ...
     * Getservicespec
     */
    async getServiceSpecRaw(requestParameters: GetServiceSpecRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ResponseGetservicespec>> {
        if (requestParameters.service === null || requestParameters.service === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseGetservicespecFromJSON(jsonValue));
    }

    /**
     * Getservicespec
     */
    async getServiceSpec(requestParameters: GetServiceSpecRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<ResponseGetservicespec> {
     ...
     * Getservicespecs
     */
    async getServiceSpecsRaw(requestParameters: GetServiceSpecsRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ResponseGetservicespecs>> {
        if (requestParameters.service === null || requestParameters.service === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseGetservicespecsFromJSON(jsonValue));
    }

    /**
     * Getservicespecs
     */
    async getServiceSpecs(requestParameters: GetServiceSpecsRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<ResponseGetservicespecs> {
     ...
     * Getserviceswithspecs
     */
    async getServicesWithSpecsRaw(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<ResponseGetserviceswithspecs>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ResponseGetserviceswithspecsFromJSON(jsonValue));
    }

    /**
     * Getserviceswithspecs
     */
    async getServicesWithSpecs(initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<ResponseGetserviceswithspecs> {
