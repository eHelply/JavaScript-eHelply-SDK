...
export interface LoggingApiInterface {
     ...
     */
    getSubjectLogsRaw(requestParameters: GetSubjectLogsRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Array<LoggingDynamo>>>;

    /**
     * Getsubjectlogs
     */
    getSubjectLogs(requestParameters: GetSubjectLogsRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Array<LoggingDynamo>>;
...
export class LoggingApi extends runtime.BaseAPI implements LoggingApiInterface {
     ...
     * Getsubjectlogs
     */
    async getSubjectLogsRaw(requestParameters: GetSubjectLogsRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Array<LoggingDynamo>>> {
     ...
     * Getsubjectlogs
     */
    async getSubjectLogs(requestParameters: GetSubjectLogsRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Array<LoggingDynamo>> {
