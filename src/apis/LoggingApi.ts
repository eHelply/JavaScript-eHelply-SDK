...
export interface LoggingApiInterface {
     ...
     */
    getLogsRaw(requestParameters: GetLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<LoggingDynamo>>>;

    /**
     * Getlogs
     */
    getLogs(requestParameters: GetLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<LoggingDynamo>>;
     ...
     * @memberof LoggingApiInterface
     */
    getServiceLogsRaw(requestParameters: GetServiceLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<LoggingDynamo>>>;

    /**
     * Getservicelogs
     */
    getServiceLogs(requestParameters: GetServiceLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<LoggingDynamo>>;
     ...
     * @memberof LoggingApiInterface
     */
    getSubjectLogsRaw(requestParameters: GetSubjectLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>>;

    /**
     * Getsubjectlogs
     */
    getSubjectLogs(requestParameters: GetSubjectLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object>;
...
export class LoggingApi extends runtime.BaseAPI implements LoggingApiInterface {
     ...
     * Getlogs
     */
    async getLogsRaw(requestParameters: GetLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<LoggingDynamo>>> {
     ...
     * Getlogs
     */
    async getLogs(requestParameters: GetLogsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<LoggingDynamo>> {
     ...
     * Getservicelogs
     */
    async getServiceLogsRaw(requestParameters: GetServiceLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<LoggingDynamo>>> {
     ...
     * Getservicelogs
     */
    async getServiceLogs(requestParameters: GetServiceLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<LoggingDynamo>> {
     ...
     * Getsubjectlogs
     */
    async getSubjectLogsRaw(requestParameters: GetSubjectLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.service === null || requestParameters.service === undefined) {
     ...
     * Getsubjectlogs
     */
    async getSubjectLogs(requestParameters: GetSubjectLogsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
