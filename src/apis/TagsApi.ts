...
export interface TagsApiInterface {
     ...
     */
    createTagRaw(requestParameters: CreateTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagDb>>;

    /**
     * Creates a tag
     * Createtag
     */
    createTag(requestParameters: CreateTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagDb>;
     ...
     * @memberof TagsApiInterface
     */
    getTagRaw(requestParameters: GetTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagBase>>;

    /**
     * Gets the tag member information given the tag ID
     * Gettag
     */
    getTag(requestParameters: GetTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagBase>;
     ...
     * @memberof TagsApiInterface
     */
    updateTagRaw(requestParameters: UpdateTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagBase>>;

    /**
     * Update tag with given info, only updating the fields supplied. Tag Uuid must be sent however.
     * Updatetag
     */
    updateTag(requestParameters: UpdateTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagBase>;
...
export class TagsApi extends runtime.BaseAPI implements TagsApiInterface {
     ...
     * Createtag
     */
    async createTagRaw(requestParameters: CreateTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagDb>> {
     ...
     * Createtag
     */
    async createTag(requestParameters: CreateTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagDb> {
     ...
     * Gettag
     */
    async getTagRaw(requestParameters: GetTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagBase>> {
     ...
     * Gettag
     */
    async getTag(requestParameters: GetTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagBase> {
     ...
     * Updatetag
     */
    async updateTagRaw(requestParameters: UpdateTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagBase>> {
        if (requestParameters.tagUuid === null || requestParameters.tagUuid === undefined) {
     ...
     * Updatetag
     */
    async updateTag(requestParameters: UpdateTagRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagBase> {
