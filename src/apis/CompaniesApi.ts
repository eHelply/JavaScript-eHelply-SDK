...
export interface CompaniesApiInterface {
     ...
     */
    createCompanyPlacesCompaniesPostRaw(requestParameters: CreateCompanyPlacesCompaniesPostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CompanyResponse>>;

    /**
     * Creates a company
     * Create Company
     */
    createCompanyPlacesCompaniesPost(requestParameters: CreateCompanyPlacesCompaniesPostRequest, initOverrides?: RequestInit): Promise<CompanyResponse>;
     ...
     * @memberof CompaniesApiInterface
     */
    deletePlacePlacesCompaniesCompanyUuidDeleteRaw(requestParameters: DeletePlacePlacesCompaniesCompanyUuidDeleteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>>;

    /**
     * Deletes the company with the given ID and returns True if successful
     * Delete Place
     */
    deletePlacePlacesCompaniesCompanyUuidDelete(requestParameters: DeletePlacePlacesCompaniesCompanyUuidDeleteRequest, initOverrides?: RequestInit): Promise<any>;
     ...
     * @memberof CompaniesApiInterface
     */
    getCompanyPlacesCompaniesCompanyUuidGetRaw(requestParameters: GetCompanyPlacesCompaniesCompanyUuidGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CompanyResponse>>;

    /**
     * Gets the company information given the Place ID
     * Get Company
     */
    getCompanyPlacesCompaniesCompanyUuidGet(requestParameters: GetCompanyPlacesCompaniesCompanyUuidGetRequest, initOverrides?: RequestInit): Promise<CompanyResponse>;
     ...
     * @memberof CompaniesApiInterface
     */
    searchCompaniesPlacesCompaniesGetRaw(requestParameters: SearchCompaniesPlacesCompaniesGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Page>>;

    /**
     * Search all companies and returns paginated results with Companies being stored in items field. Can search by `project_uuid, name, email` string fields or the `is_public and is_deleted` boolean fields. To search with these fields use query params with string values. For sorting fill out \"sort_desc\" field with either true/false and the \"sort_on\" query parameter with column you want to sort on (ex: name). Max pagination items per page is 50. Item return format: ``` {     uuid                                **type:** string     project_uuid                        **type:** string or None      meta_uuid                           **type:** string or None      catalog_data                        **type:** dict or None      review_group_data                   **type:** dict or None      schedule_data                       **type:** dict or None      blog_data                           **type:** dict or None      tags                                **type:** [TagBase] or None      categories                          **type:** [CategoryBase] or None      places                              **type:** PlaceBase or None      created_at                          **type:** string or None      updated_at                          **type:** string or None      deleted_at                          **type:** string or None  } ```
     * Search Companies
     */
    searchCompaniesPlacesCompaniesGet(requestParameters: SearchCompaniesPlacesCompaniesGetRequest, initOverrides?: RequestInit): Promise<Page>;
     ...
     * @memberof CompaniesApiInterface
     */
    updateCompanyPlacesCompaniesCompanyUuidPutRaw(requestParameters: UpdateCompanyPlacesCompaniesCompanyUuidPutRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CompanyResponse>>;

    /**
     * Update company with given info, only updating the fields supplied. Company Uuid must be sent however.
     * Update Company
     */
    updateCompanyPlacesCompaniesCompanyUuidPut(requestParameters: UpdateCompanyPlacesCompaniesCompanyUuidPutRequest, initOverrides?: RequestInit): Promise<CompanyResponse>;
...
export class CompaniesApi extends runtime.BaseAPI implements CompaniesApiInterface {
     ...
     * Create Company
     */
    async createCompanyPlacesCompaniesPostRaw(requestParameters: CreateCompanyPlacesCompaniesPostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CompanyResponse>> {
     ...
     * Create Company
     */
    async createCompanyPlacesCompaniesPost(requestParameters: CreateCompanyPlacesCompaniesPostRequest, initOverrides?: RequestInit): Promise<CompanyResponse> {
     ...
     * Delete Place
     */
    async deletePlacePlacesCompaniesCompanyUuidDeleteRaw(requestParameters: DeletePlacePlacesCompaniesCompanyUuidDeleteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>> {
     ...
     * Delete Place
     */
    async deletePlacePlacesCompaniesCompanyUuidDelete(requestParameters: DeletePlacePlacesCompaniesCompanyUuidDeleteRequest, initOverrides?: RequestInit): Promise<any> {
     ...
     * Get Company
     */
    async getCompanyPlacesCompaniesCompanyUuidGetRaw(requestParameters: GetCompanyPlacesCompaniesCompanyUuidGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CompanyResponse>> {
        if (requestParameters.companyUuid === null || requestParameters.companyUuid === undefined) {
     ...
     * Get Company
     */
    async getCompanyPlacesCompaniesCompanyUuidGet(requestParameters: GetCompanyPlacesCompaniesCompanyUuidGetRequest, initOverrides?: RequestInit): Promise<CompanyResponse> {
     ...
     * Search Companies
     */
    async searchCompaniesPlacesCompaniesGetRaw(requestParameters: SearchCompaniesPlacesCompaniesGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Page>> {
        const queryParameters: any = {};
     ...
     * Search Companies
     */
    async searchCompaniesPlacesCompaniesGet(requestParameters: SearchCompaniesPlacesCompaniesGetRequest = {}, initOverrides?: RequestInit): Promise<Page> {
     ...
     * Update Company
     */
    async updateCompanyPlacesCompaniesCompanyUuidPutRaw(requestParameters: UpdateCompanyPlacesCompaniesCompanyUuidPutRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CompanyResponse>> {
        if (requestParameters.companyUuid === null || requestParameters.companyUuid === undefined) {
     ...
     * Update Company
     */
    async updateCompanyPlacesCompaniesCompanyUuidPut(requestParameters: UpdateCompanyPlacesCompaniesCompanyUuidPutRequest, initOverrides?: RequestInit): Promise<CompanyResponse> {
