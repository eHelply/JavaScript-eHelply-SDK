...
export interface CompaniesApiInterface {
     ...
     * @memberof CompaniesApiInterface
     */
    deletePlacePlacesCompaniesCompanyUuidDeleteRaw(requestParameters: DeletePlacePlacesCompaniesCompanyUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>>;

    /**
     * Deletes the company with the given ID and returns True if successful
     * Delete Place
     */
    deletePlacePlacesCompaniesCompanyUuidDelete(requestParameters: DeletePlacePlacesCompaniesCompanyUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any>;
...
export class CompaniesApi extends runtime.BaseAPI implements CompaniesApiInterface {
     ...
     * Delete Place
     */
    async deletePlacePlacesCompaniesCompanyUuidDeleteRaw(requestParameters: DeletePlacePlacesCompaniesCompanyUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Delete Place
     */
    async deletePlacePlacesCompaniesCompanyUuidDelete(requestParameters: DeletePlacePlacesCompaniesCompanyUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any> {
