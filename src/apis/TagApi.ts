...
export interface TagApiInterface {
     ...
     */
    createTagPlacesTagsPostRaw(requestParameters: CreateTagPlacesTagsPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagDb>>;

    /**
     * Creates a tag
     * Create Tag
     */
    createTagPlacesTagsPost(requestParameters: CreateTagPlacesTagsPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagDb>;
     ...
     * @memberof TagApiInterface
     */
    deleteTagPlacesTagsTagUuidDeleteRaw(requestParameters: DeleteTagPlacesTagsTagUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>>;

    /**
     * Deletes the tag member with the given ID and returns True if successful
     * Delete Tag
     */
    deleteTagPlacesTagsTagUuidDelete(requestParameters: DeleteTagPlacesTagsTagUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any>;
     ...
     * @memberof TagApiInterface
     */
    getTagPlacesTagsTagUuidGetRaw(requestParameters: GetTagPlacesTagsTagUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagBase>>;

    /**
     * Gets the tag member information given the tag ID
     * Get Tag
     */
    getTagPlacesTagsTagUuidGet(requestParameters: GetTagPlacesTagsTagUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagBase>;
     ...
     * @memberof TagApiInterface
     */
    searchTagsPlacesTagsGetRaw(requestParameters: SearchTagsPlacesTagsGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>>;

    /**
     * TODO Item return format: ``` {     uuid                                **type:** string     project_uuid                        **type:** string or None      name                                **type:** string or None      meta                                **type:** dict or None      created_at                          **type:** string or None      updated_at                          **type:** string or None      deleted_at                          **type:** string or None  } ```
     * Search Tags
     */
    searchTagsPlacesTagsGet(requestParameters: SearchTagsPlacesTagsGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page>;
     ...
     * @memberof TagApiInterface
     */
    updateTagPlacesTagsTagUuidPutRaw(requestParameters: UpdateTagPlacesTagsTagUuidPutRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagBase>>;

    /**
     * Update tag with given info, only updating the fields supplied. Tag Uuid must be sent however.
     * Update Tag
     */
    updateTagPlacesTagsTagUuidPut(requestParameters: UpdateTagPlacesTagsTagUuidPutRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagBase>;
...
export class TagApi extends runtime.BaseAPI implements TagApiInterface {
     ...
     * Create Tag
     */
    async createTagPlacesTagsPostRaw(requestParameters: CreateTagPlacesTagsPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagDb>> {
     ...
     * Create Tag
     */
    async createTagPlacesTagsPost(requestParameters: CreateTagPlacesTagsPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagDb> {
     ...
     * Delete Tag
     */
    async deleteTagPlacesTagsTagUuidDeleteRaw(requestParameters: DeleteTagPlacesTagsTagUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Delete Tag
     */
    async deleteTagPlacesTagsTagUuidDelete(requestParameters: DeleteTagPlacesTagsTagUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any> {
     ...
     * Get Tag
     */
    async getTagPlacesTagsTagUuidGetRaw(requestParameters: GetTagPlacesTagsTagUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagBase>> {
        if (requestParameters.tagUuid === null || requestParameters.tagUuid === undefined) {
     ...
     * Get Tag
     */
    async getTagPlacesTagsTagUuidGet(requestParameters: GetTagPlacesTagsTagUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagBase> {
     ...
     * Search Tags
     */
    async searchTagsPlacesTagsGetRaw(requestParameters: SearchTagsPlacesTagsGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>> {
        const queryParameters: any = {};
     ...
     * Search Tags
     */
    async searchTagsPlacesTagsGet(requestParameters: SearchTagsPlacesTagsGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page> {
     ...
     * Update Tag
     */
    async updateTagPlacesTagsTagUuidPutRaw(requestParameters: UpdateTagPlacesTagsTagUuidPutRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<TagBase>> {
        if (requestParameters.tagUuid === null || requestParameters.tagUuid === undefined) {
     ...
     * Update Tag
     */
    async updateTagPlacesTagsTagUuidPut(requestParameters: UpdateTagPlacesTagsTagUuidPutRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<TagBase> {
