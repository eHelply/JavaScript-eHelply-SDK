...
export interface CategoryApiInterface {
     ...
     */
    createCategoryPlacesCategoriesPostRaw(requestParameters: CreateCategoryPlacesCategoriesPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<CategoryResponse>>;

    /**
     * Creates a category
     * Create Category
     */
    createCategoryPlacesCategoriesPost(requestParameters: CreateCategoryPlacesCategoriesPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<CategoryResponse>;
     ...
     * @memberof CategoryApiInterface
     */
    getCategoryPlacesCategoriesCategoryUuidGetRaw(requestParameters: GetCategoryPlacesCategoriesCategoryUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<CategoryResponse>>;

    /**
     * Gets the category information given the category ID
     * Get Category
     */
    getCategoryPlacesCategoriesCategoryUuidGet(requestParameters: GetCategoryPlacesCategoriesCategoryUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<CategoryResponse>;
...
export class CategoryApi extends runtime.BaseAPI implements CategoryApiInterface {
     ...
     * Create Category
     */
    async createCategoryPlacesCategoriesPostRaw(requestParameters: CreateCategoryPlacesCategoriesPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<CategoryResponse>> {
     ...
     * Create Category
     */
    async createCategoryPlacesCategoriesPost(requestParameters: CreateCategoryPlacesCategoriesPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<CategoryResponse> {
     ...
     * Get Category
     */
    async getCategoryPlacesCategoriesCategoryUuidGetRaw(requestParameters: GetCategoryPlacesCategoriesCategoryUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<CategoryResponse>> {
        if (requestParameters.categoryUuid === null || requestParameters.categoryUuid === undefined) {
     ...
     * Get Category
     */
    async getCategoryPlacesCategoriesCategoryUuidGet(requestParameters: GetCategoryPlacesCategoriesCategoryUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<CategoryResponse> {
