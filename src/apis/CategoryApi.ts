...
export interface CategoryApiInterface {
     ...
     */
    createCategoryPlacesCategoriesPostRaw(requestParameters: CreateCategoryPlacesCategoriesPostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CategoryDb>>;

    /**
     * Creates a category
     * Create Category
     */
    createCategoryPlacesCategoriesPost(requestParameters: CreateCategoryPlacesCategoriesPostRequest, initOverrides?: RequestInit): Promise<CategoryDb>;
     ...
     * @memberof CategoryApiInterface
     */
    deleteCategoryPlacesCategoriesCategoryUuidDeleteRaw(requestParameters: DeleteCategoryPlacesCategoriesCategoryUuidDeleteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>>;

    /**
     * Deletes the category with the given ID and returns True if successful
     * Delete Category
     */
    deleteCategoryPlacesCategoriesCategoryUuidDelete(requestParameters: DeleteCategoryPlacesCategoriesCategoryUuidDeleteRequest, initOverrides?: RequestInit): Promise<any>;
     ...
     * @memberof CategoryApiInterface
     */
    getCategoryPlacesCategoriesCategoryUuidGetRaw(requestParameters: GetCategoryPlacesCategoriesCategoryUuidGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CategoryBase>>;

    /**
     * Gets the category information given the category ID
     * Get Category
     */
    getCategoryPlacesCategoriesCategoryUuidGet(requestParameters: GetCategoryPlacesCategoriesCategoryUuidGetRequest, initOverrides?: RequestInit): Promise<CategoryBase>;
     ...
     * @memberof CategoryApiInterface
     */
    searchCategoriesPlacesCategoriesGetRaw(requestParameters: SearchCategoriesPlacesCategoriesGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Page>>;

    /**
     * TODO Item return format: ``` {     uuid                                **type:** string     project_uuid                        **type:** string or None      name                                **type:** string or None      meta                                **type:** dict or None      created_at                          **type:** string or None      updated_at                          **type:** string or None      deleted_at                          **type:** string or None  } ```
     * Search Categories
     */
    searchCategoriesPlacesCategoriesGet(requestParameters: SearchCategoriesPlacesCategoriesGetRequest, initOverrides?: RequestInit): Promise<Page>;
     ...
     * @memberof CategoryApiInterface
     */
    updateCategoryPlacesCategoriesCategoryUuidPutRaw(requestParameters: UpdateCategoryPlacesCategoriesCategoryUuidPutRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CategoryBase>>;

    /**
     * Update category with given info, only updating the fields supplied. Category Uuid must be sent however.
     * Update Category
     */
    updateCategoryPlacesCategoriesCategoryUuidPut(requestParameters: UpdateCategoryPlacesCategoriesCategoryUuidPutRequest, initOverrides?: RequestInit): Promise<CategoryBase>;
...
export class CategoryApi extends runtime.BaseAPI implements CategoryApiInterface {
     ...
     * Create Category
     */
    async createCategoryPlacesCategoriesPostRaw(requestParameters: CreateCategoryPlacesCategoriesPostRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CategoryDb>> {
     ...
     * Create Category
     */
    async createCategoryPlacesCategoriesPost(requestParameters: CreateCategoryPlacesCategoriesPostRequest, initOverrides?: RequestInit): Promise<CategoryDb> {
     ...
     * Delete Category
     */
    async deleteCategoryPlacesCategoriesCategoryUuidDeleteRaw(requestParameters: DeleteCategoryPlacesCategoriesCategoryUuidDeleteRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>> {
     ...
     * Delete Category
     */
    async deleteCategoryPlacesCategoriesCategoryUuidDelete(requestParameters: DeleteCategoryPlacesCategoriesCategoryUuidDeleteRequest, initOverrides?: RequestInit): Promise<any> {
     ...
     * Get Category
     */
    async getCategoryPlacesCategoriesCategoryUuidGetRaw(requestParameters: GetCategoryPlacesCategoriesCategoryUuidGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CategoryBase>> {
        if (requestParameters.categoryUuid === null || requestParameters.categoryUuid === undefined) {
     ...
     * Get Category
     */
    async getCategoryPlacesCategoriesCategoryUuidGet(requestParameters: GetCategoryPlacesCategoriesCategoryUuidGetRequest, initOverrides?: RequestInit): Promise<CategoryBase> {
     ...
     * Search Categories
     */
    async searchCategoriesPlacesCategoriesGetRaw(requestParameters: SearchCategoriesPlacesCategoriesGetRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Page>> {
        const queryParameters: any = {};
     ...
     * Search Categories
     */
    async searchCategoriesPlacesCategoriesGet(requestParameters: SearchCategoriesPlacesCategoriesGetRequest = {}, initOverrides?: RequestInit): Promise<Page> {
     ...
     * Update Category
     */
    async updateCategoryPlacesCategoriesCategoryUuidPutRaw(requestParameters: UpdateCategoryPlacesCategoriesCategoryUuidPutRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<CategoryBase>> {
        if (requestParameters.categoryUuid === null || requestParameters.categoryUuid === undefined) {
     ...
     * Update Category
     */
    async updateCategoryPlacesCategoriesCategoryUuidPut(requestParameters: UpdateCategoryPlacesCategoriesCategoryUuidPutRequest, initOverrides?: RequestInit): Promise<CategoryBase> {
