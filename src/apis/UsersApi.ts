...
export interface UsersApiInterface {
     ...
     */
    confirmSignupRaw(requestParameters: ConfirmSignupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>>;

    /**
     * Validates a user signup with a given confirmation
     * Confirmsignup
     */
    confirmSignup(requestParameters: ConfirmSignupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object>;
     ...
     * @memberof UsersApiInterface
     */
    createParticipantRaw(requestParameters: CreateParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ParticipantUserReturn>>;

    /**
     * Creates a participant given the participant info (meta and user_id)
     * Createparticipant
     */
    createParticipant(requestParameters: CreateParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ParticipantUserReturn>;
     ...
     * @memberof UsersApiInterface
     */
    deleteParticipantRaw(requestParameters: DeleteParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<boolean>>;

    /**
     * Delete participants related to the given participant_id, returns True if successful
     * Deleteparticipant
     */
    deleteParticipant(requestParameters: DeleteParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<boolean>;
     ...
     * @memberof UsersApiInterface
     */
    deleteUserRaw(requestParameters: DeleteUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<boolean>>;

    /**
     * Soft deletes the user with the provided user id, granted the deleter is the same person or an admin. Returns True if successful
     * Deleteuser
     */
    deleteUser(requestParameters: DeleteUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<boolean>;
     ...
     * @memberof UsersApiInterface
     */
    getParticipantRaw(requestParameters: GetParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ParticipantUserReturn>>;

    /**
     * Gets a participant given their participant ID
     * Getparticipant
     */
    getParticipant(requestParameters: GetParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ParticipantUserReturn>;
     ...
     * @memberof UsersApiInterface
     */
    loginRaw(requestParameters: LoginRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserLoginReturn>>;

    /**
     * Login endpoint, returns tokens. EMAIL NEEDS TO BE VERIFIED (can be done through the email the user received).
     * Login
     */
    login(requestParameters: LoginRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserLoginReturn>;
     ...
     * @memberof UsersApiInterface
     */
    refreshTokenRaw(requestParameters: RefreshTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserTokenReturn>>;

    /**
     * Refreshes tokens given a refresh token.
     * Refreshtoken
     */
    refreshToken(requestParameters: RefreshTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserTokenReturn>;
     ...
     * @memberof UsersApiInterface
     */
    resetPasswordConfirmationRaw(requestParameters: ResetPasswordConfirmationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>>;

    /**
     * Resets the given user\'s password to the given password when the proper code is provided
     * Resetpasswordconfirmation
     */
    resetPasswordConfirmation(requestParameters: ResetPasswordConfirmationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object>;
     ...
     * @memberof UsersApiInterface
     */
    searchParticipantsRaw(requestParameters: SearchParticipantsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Page>>;

    /**
     * Search participants using a user uuid, returns pagination information and list of `items` (ParticipantUserReturn from GET Participant). Can search on \"user_uuid\", and sort on any field. To search enter search value into \"search\" query param and the field into \"search on\" (currently only \"user\"uuid\"). For sorting fill out \"sort_desc\" field with either true/false and the \"sort_on\" query parameter with column you want to sort on (ex: date_created). Max pagination items per page is 50.
     * Searchparticipants
     */
    searchParticipants(requestParameters: SearchParticipantsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Page>;
     ...
     * @memberof UsersApiInterface
     */
    signupRaw(requestParameters: SignupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserSignupReturn>>;

    /**
     * Signup to eHelply, creates a user and default participant behind the scenes. Does not verify email.
     * Signup
     */
    signup(requestParameters: SignupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserSignupReturn>;
     ...
     * @memberof UsersApiInterface
     */
    updateParticipantRaw(requestParameters: UpdateParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ParticipantUserReturn>>;

    /**
     * Update participant data given
     * Updateparticipant
     */
    updateParticipant(requestParameters: UpdateParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ParticipantUserReturn>;
     ...
     * @memberof UsersApiInterface
     */
    userValidationsRaw(requestParameters: UserValidationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<boolean>>;

    /**
     * Validates a certain field.
     * Uservalidations
     */
    userValidations(requestParameters: UserValidationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<boolean>;
...
export class UsersApi extends runtime.BaseAPI implements UsersApiInterface {
     ...
     * Confirmsignup
     */
    async confirmSignupRaw(requestParameters: ConfirmSignupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
     ...
     * Confirmsignup
     */
    async confirmSignup(requestParameters: ConfirmSignupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
     ...
     * Createparticipant
     */
    async createParticipantRaw(requestParameters: CreateParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ParticipantUserReturn>> {
     ...
     * Createparticipant
     */
    async createParticipant(requestParameters: CreateParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ParticipantUserReturn> {
     ...
     * Deleteparticipant
     */
    async deleteParticipantRaw(requestParameters: DeleteParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<boolean>> {
     ...
     * Deleteparticipant
     */
    async deleteParticipant(requestParameters: DeleteParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<boolean> {
     ...
     * Getparticipant
     */
    async getParticipantRaw(requestParameters: GetParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ParticipantUserReturn>> {
        if (requestParameters.participantId === null || requestParameters.participantId === undefined) {
     ...
     * Getparticipant
     */
    async getParticipant(requestParameters: GetParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ParticipantUserReturn> {
     ...
     * Login
     */
    async loginRaw(requestParameters: LoginRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserLoginReturn>> {
     ...
     * Login
     */
    async login(requestParameters: LoginRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserLoginReturn> {
     ...
     * Refreshtoken
     */
    async refreshTokenRaw(requestParameters: RefreshTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserTokenReturn>> {
     ...
     * Refreshtoken
     */
    async refreshToken(requestParameters: RefreshTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserTokenReturn> {
     ...
     * Resetpasswordconfirmation
     */
    async resetPasswordConfirmationRaw(requestParameters: ResetPasswordConfirmationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
     ...
     * Resetpasswordconfirmation
     */
    async resetPasswordConfirmation(requestParameters: ResetPasswordConfirmationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
     ...
     * Searchparticipants
     */
    async searchParticipantsRaw(requestParameters: SearchParticipantsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Page>> {
        const queryParameters: any = {};
     ...
     * Searchparticipants
     */
    async searchParticipants(requestParameters: SearchParticipantsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Page> {
     ...
     * Signup
     */
    async signupRaw(requestParameters: SignupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserSignupReturn>> {
     ...
     * Signup
     */
    async signup(requestParameters: SignupRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserSignupReturn> {
     ...
     * Updateparticipant
     */
    async updateParticipantRaw(requestParameters: UpdateParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ParticipantUserReturn>> {
        if (requestParameters.participantId === null || requestParameters.participantId === undefined) {
     ...
     * Updateparticipant
     */
    async updateParticipant(requestParameters: UpdateParticipantRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ParticipantUserReturn> {
     ...
     * Uservalidations
     */
    async userValidationsRaw(requestParameters: UserValidationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<boolean>> {
     ...
     * Uservalidations
     */
    async userValidations(requestParameters: UserValidationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<boolean> {
