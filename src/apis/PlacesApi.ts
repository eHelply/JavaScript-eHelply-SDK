...
export interface AdvancedSearchPlacesRequest {
    searchString?: string;
    page?: number;
    pageSize?: number;
    sortOn?: string;
...
export interface PlacesApiInterface {
     ...
     */
    advancedSearchPlacesRaw(requestParameters: AdvancedSearchPlacesRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>>;

    /**
     * Search places by a search string
     * Advancedsearchplaces
     */
    advancedSearchPlaces(requestParameters: AdvancedSearchPlacesRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page>;
     ...
     * @memberof PlacesApiInterface
     */
    deletePlaceRaw(requestParameters: DeletePlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>>;

    /**
     * Deletes the place with the given ID and returns True if successful
     * Deleteplace
     */
    deletePlace(requestParameters: DeletePlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any>;
     ...
     * @memberof PlacesApiInterface
     */
    getPlaceRaw(requestParameters: GetPlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<PlaceResponse>>;

    /**
     * Gets the place information given the Place ID
     * Getplace
     */
    getPlace(requestParameters: GetPlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<PlaceResponse>;
     ...
     * @memberof PlacesApiInterface
     */
    searchPlacesRaw(requestParameters: SearchPlacesRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>>;

    /**
     * Search all places and returns paginated results with Places being stored in items field. Can search by `project_uuid, name, address, address_line_2, city, province_state, country, postal_zip_code, lat, lng email` string fields or the `is_public and is_deleted` boolean fields. To search with these fields use query params with string values. For sorting fill out \"sort_desc\" field with either true/false and the \"sort_on\" query parameter with column you want to sort on (ex: name). Max pagination items per page is 50. Item return format: ``` {     uuid                                **type:** string     project_uuid                        **type:** string or None      meta_uuid                           **type:** string or None      catalog_data                        **type:** dict or None      review_group_data                   **type:** dict or None      schedule_data                       **type:** dict or None      collection_data                     **type:** dict or None      blog_data                           **type:** dict or None      tags                                **type:** [TagBase] or None      categories                          **type:** [CategoryBase] or None      company                             **type:** CompanyBase or None      created_at                          **type:** string or None      updated_at                          **type:** string or None      deleted_at                          **type:** string or None  } ```
     * Searchplaces
     */
    searchPlaces(requestParameters: SearchPlacesRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page>;
     ...
     * @memberof PlacesApiInterface
     */
    updatePlaceRaw(requestParameters: UpdatePlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<PlaceResponse>>;

    /**
     * Update Place with given info, only updating the fields supplied. Place Uuid must be sent however.
     * Updateplace
     */
    updatePlace(requestParameters: UpdatePlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<PlaceResponse>;
...
export class PlacesApi extends runtime.BaseAPI implements PlacesApiInterface {
     ...
     * Advancedsearchplaces
     */
    async advancedSearchPlacesRaw(requestParameters: AdvancedSearchPlacesRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>> {
     ...
     * Advancedsearchplaces
     */
    async advancedSearchPlaces(requestParameters: AdvancedSearchPlacesRequest = {}, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page> {
        const response = await this.advancedSearchPlacesRaw(requestParameters, initOverrides);
     ...
     * Deleteplace
     */
    async deletePlaceRaw(requestParameters: DeletePlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters.placeUuid === null || requestParameters.placeUuid === undefined) {
            throw new runtime.RequiredError('placeUuid','Required parameter requestParameters.placeUuid was null or undefined when calling deletePlace.');
        }
     ...
     * Deleteplace
     */
    async deletePlace(requestParameters: DeletePlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any> {
        const response = await this.deletePlaceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Getplace
     */
    async getPlaceRaw(requestParameters: GetPlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<PlaceResponse>> {
        if (requestParameters.placeUuid === null || requestParameters.placeUuid === undefined) {
            throw new runtime.RequiredError('placeUuid','Required parameter requestParameters.placeUuid was null or undefined when calling getPlace.');
        }
     ...
     * Getplace
     */
    async getPlace(requestParameters: GetPlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<PlaceResponse> {
     ...
     * Searchplaces
     */
    async searchPlacesRaw(requestParameters: SearchPlacesRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>> {
        const queryParameters: any = {};
     ...
     * Searchplaces
     */
    async searchPlaces(requestParameters: SearchPlacesRequest = {}, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page> {
     ...
     * Updateplace
     */
    async updatePlaceRaw(requestParameters: UpdatePlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<PlaceResponse>> {
        if (requestParameters.placeUuid === null || requestParameters.placeUuid === undefined) {
            throw new runtime.RequiredError('placeUuid','Required parameter requestParameters.placeUuid was null or undefined when calling updatePlace.');
        }

        if (requestParameters.placeBase === null || requestParameters.placeBase === undefined) {
            throw new runtime.RequiredError('placeBase','Required parameter requestParameters.placeBase was null or undefined when calling updatePlace.');
        }
     ...
     * Updateplace
     */
    async updatePlace(requestParameters: UpdatePlaceRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<PlaceResponse> {
