...
export interface PlacesApiInterface {
     ...
     */
    createPlacePlacesPlacesPostRaw(requestParameters: CreatePlacePlacesPlacesPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<PlaceResponse>>;

    /**
     * Creates a Place.
     * Create Place
     */
    createPlacePlacesPlacesPost(requestParameters: CreatePlacePlacesPlacesPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<PlaceResponse>;
     ...
     * @memberof PlacesApiInterface
     */
    deletePlacePlacesPlacesPlaceUuidDeleteRaw(requestParameters: DeletePlacePlacesPlacesPlaceUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>>;

    /**
     * Deletes the place with the given ID and returns True if successful
     * Delete Place
     */
    deletePlacePlacesPlacesPlaceUuidDelete(requestParameters: DeletePlacePlacesPlacesPlaceUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any>;
     ...
     * @memberof PlacesApiInterface
     */
    forwardGeocodingPlacesGeocodingForwardGetRaw(requestParameters: ForwardGeocodingPlacesGeocodingForwardGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>>;

    /**
     * Forward Geocoding
     */
    forwardGeocodingPlacesGeocodingForwardGet(requestParameters: ForwardGeocodingPlacesGeocodingForwardGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any>;
     ...
     * @memberof PlacesApiInterface
     */
    getPlacePlacesPlacesPlaceUuidGetRaw(requestParameters: GetPlacePlacesPlacesPlaceUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<PlaceResponse>>;

    /**
     * Gets the place information given the Place ID
     * Get Place
     */
    getPlacePlacesPlacesPlaceUuidGet(requestParameters: GetPlacePlacesPlacesPlaceUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<PlaceResponse>;
     ...
     * @memberof PlacesApiInterface
     */
    reverseGeocodingPlacesGeocodingReverseGetRaw(requestParameters: ReverseGeocodingPlacesGeocodingReverseGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>>;

    /**
     * Reverse Geocoding
     */
    reverseGeocodingPlacesGeocodingReverseGet(requestParameters: ReverseGeocodingPlacesGeocodingReverseGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any>;
     ...
     * @memberof PlacesApiInterface
     */
    searchPlacesBySearchStringPlacesSearchPlacesStringGetRaw(requestParameters: SearchPlacesBySearchStringPlacesSearchPlacesStringGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>>;

    /**
     * Search places by a search string
     * Search Places By Search String
     */
    searchPlacesBySearchStringPlacesSearchPlacesStringGet(requestParameters: SearchPlacesBySearchStringPlacesSearchPlacesStringGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page>;
     ...
     * @memberof PlacesApiInterface
     */
    searchPlacesPlacesPlacesGetRaw(requestParameters: SearchPlacesPlacesPlacesGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>>;

    /**
     * Search all places and returns paginated results with Places being stored in items field. Can search by `project_uuid, name, address, address_line_2, city, province_state, country, postal_zip_code, lat, lng email` string fields or the `is_public and is_deleted` boolean fields. To search with these fields use query params with string values. For sorting fill out \"sort_desc\" field with either true/false and the \"sort_on\" query parameter with column you want to sort on (ex: name). Max pagination items per page is 50. Item return format: ``` {     uuid                                **type:** string     project_uuid                        **type:** string or None      meta_uuid                           **type:** string or None      catalog_data                        **type:** dict or None      review_group_data                   **type:** dict or None      schedule_data                       **type:** dict or None      collection_data                     **type:** dict or None      blog_data                           **type:** dict or None      tags                                **type:** [TagBase] or None      categories                          **type:** [CategoryBase] or None      company                             **type:** CompanyBase or None      created_at                          **type:** string or None      updated_at                          **type:** string or None      deleted_at                          **type:** string or None  } ```
     * Search Places
     */
    searchPlacesPlacesPlacesGet(requestParameters: SearchPlacesPlacesPlacesGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page>;
     ...
     * @memberof PlacesApiInterface
     */
    updatePlacePlacesPlacesPlaceUuidPutRaw(requestParameters: UpdatePlacePlacesPlacesPlaceUuidPutRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<PlaceResponse>>;

    /**
     * Update Place with given info, only updating the fields supplied. Place Uuid must be sent however.
     * Update Place
     */
    updatePlacePlacesPlacesPlaceUuidPut(requestParameters: UpdatePlacePlacesPlacesPlaceUuidPutRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<PlaceResponse>;
...
export class PlacesApi extends runtime.BaseAPI implements PlacesApiInterface {
     ...
     * Create Place
     */
    async createPlacePlacesPlacesPostRaw(requestParameters: CreatePlacePlacesPlacesPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<PlaceResponse>> {
     ...
     * Create Place
     */
    async createPlacePlacesPlacesPost(requestParameters: CreatePlacePlacesPlacesPostRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<PlaceResponse> {
     ...
     * Delete Place
     */
    async deletePlacePlacesPlacesPlaceUuidDeleteRaw(requestParameters: DeletePlacePlacesPlacesPlaceUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Delete Place
     */
    async deletePlacePlacesPlacesPlaceUuidDelete(requestParameters: DeletePlacePlacesPlacesPlaceUuidDeleteRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any> {
     ...
     * Forward Geocoding
     */
    async forwardGeocodingPlacesGeocodingForwardGetRaw(requestParameters: ForwardGeocodingPlacesGeocodingForwardGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Forward Geocoding
     */
    async forwardGeocodingPlacesGeocodingForwardGet(requestParameters: ForwardGeocodingPlacesGeocodingForwardGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any> {
     ...
     * Get Place
     */
    async getPlacePlacesPlacesPlaceUuidGetRaw(requestParameters: GetPlacePlacesPlacesPlaceUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<PlaceResponse>> {
        if (requestParameters.placeUuid === null || requestParameters.placeUuid === undefined) {
     ...
     * Get Place
     */
    async getPlacePlacesPlacesPlaceUuidGet(requestParameters: GetPlacePlacesPlacesPlaceUuidGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<PlaceResponse> {
     ...
     * Reverse Geocoding
     */
    async reverseGeocodingPlacesGeocodingReverseGetRaw(requestParameters: ReverseGeocodingPlacesGeocodingReverseGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Reverse Geocoding
     */
    async reverseGeocodingPlacesGeocodingReverseGet(requestParameters: ReverseGeocodingPlacesGeocodingReverseGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<any> {
     ...
     * Search Places By Search String
     */
    async searchPlacesBySearchStringPlacesSearchPlacesStringGetRaw(requestParameters: SearchPlacesBySearchStringPlacesSearchPlacesStringGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>> {
        const queryParameters: any = {};
     ...
     * Search Places By Search String
     */
    async searchPlacesBySearchStringPlacesSearchPlacesStringGet(requestParameters: SearchPlacesBySearchStringPlacesSearchPlacesStringGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page> {
     ...
     * Search Places
     */
    async searchPlacesPlacesPlacesGetRaw(requestParameters: SearchPlacesPlacesPlacesGetRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<Page>> {
        const queryParameters: any = {};
     ...
     * Search Places
     */
    async searchPlacesPlacesPlacesGet(requestParameters: SearchPlacesPlacesPlacesGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<Page> {
     ...
     * Update Place
     */
    async updatePlacePlacesPlacesPlaceUuidPutRaw(requestParameters: UpdatePlacePlacesPlacesPlaceUuidPutRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<runtime.ApiResponse<PlaceResponse>> {
        if (requestParameters.placeUuid === null || requestParameters.placeUuid === undefined) {
     ...
     * Update Place
     */
    async updatePlacePlacesPlacesPlaceUuidPut(requestParameters: UpdatePlacePlacesPlacesPlaceUuidPutRequest, initOverrides?: RequestInit | runtime.InitOverideFunction): Promise<PlaceResponse> {
