...
export interface DefaultApiInterface {
     ...
     */
    attachProductToCatalogRaw(requestParameters: AttachProductToCatalogRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>>;

    /**
     * Attach Product To Catalog
     */
    attachProductToCatalog(requestParameters: AttachProductToCatalogRequest, initOverrides?: RequestInit): Promise<any>;
     ...
     * @memberof DefaultApiInterface
     */
    detachProductFromCatalogRaw(requestParameters: DetachProductFromCatalogRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>>;

    /**
     * Detach Product From Catalog
     */
    detachProductFromCatalog(requestParameters: DetachProductFromCatalogRequest, initOverrides?: RequestInit): Promise<any>;
...
export class DefaultApi extends runtime.BaseAPI implements DefaultApiInterface {
     ...
     * Attach Product To Catalog
     */
    async attachProductToCatalogRaw(requestParameters: AttachProductToCatalogRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>> {
        ...
        const response = await this.request({
            path: `/catalogs/{catalog_uuid}/products/{product_uuid}`.replace(`{${"catalog_uuid"}}`, encodeURIComponent(String(requestParameters.catalogUuid))).replace(`{${"product_uuid"}}`, encodeURIComponent(String(requestParameters.productUuid))),
            method: 'POST',
     ...
     * Attach Product To Catalog
     */
    async attachProductToCatalog(requestParameters: AttachProductToCatalogRequest, initOverrides?: RequestInit): Promise<any> {
    ...
    async createReviewRaw(requestParameters: CreateReviewRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>> {
        ...
        const response = await this.request({
            path: `/reviews/types/{entity_type}/entities/{entity_uuid}`.replace(`{${"entity_type"}}`, encodeURIComponent(String(requestParameters.entityType))).replace(`{${"entity_uuid"}}`, encodeURIComponent(String(requestParameters.entityUuid))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
    ...
    async deleteCatalogRaw(requestParameters: DeleteCatalogRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<boolean>> {
        ...
        const response = await this.request({
            path: `/catalogs/{catalog_uuid}`.replace(`{${"catalog_uuid"}}`, encodeURIComponent(String(requestParameters.catalogUuid))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async deleteProductRaw(requestParameters: DeleteProductRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<boolean>> {
        ...
        const response = await this.request({
            path: `/products/{product_uuid}`.replace(`{${"product_uuid"}}`, encodeURIComponent(String(requestParameters.productUuid))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async deleteReviewRaw(requestParameters: DeleteReviewRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>> {
        ...
        const response = await this.request({
            path: `/reviews/types/{entity_type}/entities/{entity_uuid}/reviews/{review_uuid}`.replace(`{${"entity_type"}}`, encodeURIComponent(String(requestParameters.entityType))).replace(`{${"entity_uuid"}}`, encodeURIComponent(String(requestParameters.entityUuid))).replace(`{${"review_uuid"}}`, encodeURIComponent(String(requestParameters.reviewUuid))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Detach Product From Catalog
     */
    async detachProductFromCatalogRaw(requestParameters: DetachProductFromCatalogRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<any>> {
        if (requestParameters.catalogUuid === null || requestParameters.catalogUuid === undefined) {
     ...
     * Detach Product From Catalog
     */
    async detachProductFromCatalog(requestParameters: DetachProductFromCatalogRequest, initOverrides?: RequestInit): Promise<any> {
    ...
    async searchCatalogProductsRaw(requestParameters: SearchCatalogProductsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Page>> {
        ...
        const response = await this.request({
            path: `/catalogs/{catalog_uuid}/products`.replace(`{${"catalog_uuid"}}`, encodeURIComponent(String(requestParameters.catalogUuid))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async searchProductCatalogRaw(requestParameters: SearchProductCatalogRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Page>> {
        ...
        const response = await this.request({
            path: `/products/{product_uuid}/catalogs`.replace(`{${"product_uuid"}}`, encodeURIComponent(String(requestParameters.productUuid))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
