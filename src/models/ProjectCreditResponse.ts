...
/**
 * Check if a given object implements the ProjectCreditResponse interface.
 */
export function instanceOfProjectCreditResponse(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "uuid" in value;
    isInstance = isInstance && "projectUuid" in value;
    isInstance = isInstance && "creditsGranted" in value;
    isInstance = isInstance && "grantedBy" in value;
