...
/**
 * Check if a given object implements the UserSignupReturn interface.
 */
export function instanceOfUserSignupReturn(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "participantUuid" in value;
