...
/**
 * Check if a given object implements the ProjectDB interface.
 */
export function instanceOfProjectDB(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "uuid" in value;
    isInstance = isInstance && "name" in value;
    isInstance = isInstance && "createdAt" in value;
    isInstance = isInstance && "currentSpend" in value;
    isInstance = isInstance && "maxSpend" in value;
    isInstance = isInstance && "projectStatus" in value;
