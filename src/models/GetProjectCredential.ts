...
import type { GetSecret } from './GetSecret';
import {
    GetSecretFromJSON,
...
/**
 * Check if a given object implements the GetProjectCredential interface.
 */
export function instanceOfGetProjectCredential(value: object): boolean {
    let isInstance = true;
