...
/**
 * Check if a given object implements the AlarmTicket interface.
 */
export function instanceOfAlarmTicket(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "ticketUuid" in value;
