...
/**
 * Check if a given object implements the KpiResponse interface.
 */
export function instanceOfKpiResponse(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "serviceUuid" in value;
    isInstance = isInstance && "kpis" in value;
