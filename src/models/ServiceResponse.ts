...
import {
    ...
    ServiceSuperStackMetaFromJSONTyped,
    ServiceSuperStackMetaToJSON,
} from './ServiceSuperStackMeta';
...
export interface ServiceResponse {
    ...
    /**
     * 
     * @type {ServiceSuperStackMeta}
     * @memberof ServiceResponse
     */
    superstackMeta?: ServiceSuperStackMeta;
}
...
export function ServiceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceResponse {
    ...
    return {
        ...
        'superstackMeta': !exists(json, 'superstack_meta') ? undefined : ServiceSuperStackMetaFromJSON(json['superstack_meta']),
    };
}
...
export function ServiceResponseToJSON(value?: ServiceResponse | null): any {
    ...
    return {
        ...
        'superstack_meta': ServiceSuperStackMetaToJSON(value.superstackMeta),
    };
}
