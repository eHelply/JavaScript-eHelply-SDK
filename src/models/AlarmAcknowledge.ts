...
/**
 * Check if a given object implements the AlarmAcknowledge interface.
 */
export function instanceOfAlarmAcknowledge(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "acknowledgerUuid" in value;
