...
import type { DetailedMeta } from './DetailedMeta';
import {
...
/**
 * Check if a given object implements the Detailed interface.
 */
export function instanceOfDetailed(value: object): boolean {
    let isInstance = true;
